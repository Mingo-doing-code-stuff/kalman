...
\begin{frame}
    \frametitle{Kalman explained - Starting position}
    \begin{figure}
        \centering
...
% KALMAN EXAMPLE WITH THE GAUSS STUFF
\begin{frame}
    \frametitle{Kalman explained - first prediction}
    \begin{figure}
        \centering
        \includegraphics[width=0.7\textwidth]{images/02_normal_distribution_after_move.png}
        \caption{Calculated prediction at \(t_1\)}
    \end{figure}
\end{frame}

% KALMAN EXAMPLE WITH THE GAUSS STUFF
\begin{frame}
    \frametitle{Kalman explained - prediction update}
    \begin{figure}
        \centering
...
% KALMAN EXAMPLE WITH THE GAUSS STUFF
\begin{frame}
    \frametitle{Kalman explained - measurement}
    \begin{figure}
        \centering
        \includegraphics[width=0.7\textwidth]{images/04_measurement.png}
        \caption{Messured Sensor Data at \(t_1\)}
    \end{figure}
\end{frame}

% KALMAN EXAMPLE WITH THE GAUSS STUFF
\begin{frame}
    \frametitle{Kalman explained - correction}
    \begin{figure}
        \centering
        \includegraphics[width=0.7\textwidth]{images/05_correction.png}
        \caption{Correction of the estimate \(t_1\)}
    \end{figure}
\end{frame}
