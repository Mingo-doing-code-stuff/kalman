...
\begin{frame}
    ...
    \huge
    \textbf{TODO: Integration into a concrete use case}
\end{frame}
...
\begin{frame}
    ...
    We are driving to the THWS, and are passing an funnel on our way.
    We are traveling on an average of 22.22\(m/s\) (80km/h).
    ...
    \begin{tabular}{ | r | c|c|c|c|c|c|c|c|c|c|c| }
        ...
        \hline
        Distance in $m$ & 24.0 & 21.4 & 22.5 & 21.9 & 21.6 & 21.9 & 22.0 & 22.6 & 19.2 & 20.0 \\
        \hline
    \end{tabular}
\end{frame}
...
\begin{frame}
    ...
    \begin{figure}
        \centering
        \includegraphics[width=0.6\textwidth]{images/graphics/Bildschirmfoto 2024-06-02 um 16.40.09.png}
    \end{figure}
\end{frame}
