...
\begin{frame}
    ...
    % \(t_{\rm{F}} = \sqrt {\frac{2 \cdot h}{g}}\)
    \centering
    \begin{tabular}{ | r | c|c|c|c|c|c|| }
        \hline 
        Time in $\text{s}$    &     1 &     2 &     3 &     4 &      5 \\
        \hline                                               
        Height in $\text{m}$  & 495,1 & 490,4 & 455,9 & 421,5 &  377,4  \\
        \hline
        \hline
        Time in $\text{s}$     &     6 &     7 &     8 &     9 & 10  \\
        \hline
        Height in $\text{m}$   & 323,4 & 259,7 & 186,1 & 102,7 & 9,5\\
        \hline
    \end{tabular}
\end{frame}
...
\begin{frame}
    ...
    \begin{tabular}{ | l | r | r | r | r | r |  }
        ...
        \(k\) & 1 & 2 & 3 & 4 & 5 \\
        \hline 
        \(z_k\) & Nan & Nan & Nan & Nan & Nan \\
        \hline 
        \(K_k\) & Nan & Nan & Nan & Nan & Nan \\
        \hline 
        \(P_k\) & Nan & Nan & Nan & Nan & Nan \\
        \hline 
        \(\hat{x}_k\) & Nan & Nan & Nan & Nan & Nan \\
        \hline
        \hline 
        \(k\) & 6 & 7 & 8 & 9 & 10 \\
        \hline 
